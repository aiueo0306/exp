...
# ===== 固定情報（学会サイト） =====
BASE_URL = "https://medical.eisai.jp/news"
GAKKAI = "エーザイ（医療機関）"

SELECTOR_TITLE = "ul.news-list.js-news-list-area li.news-list__item"
title_selector = "p.paragraph"
title_index = 0
href_selector = "a"
href_index = 0
SELECTOR_DATE = "ul.news-list.js-news-list-area li.news-list__item"  # typo修正済み
date_selector = "p.news-list__item__content__head__date"
date_index = 0
year_unit = "."
month_unit = "."
day_unit = ""
